...
def run():
  ...
  try:
    # 執行檔的路徑 webdriver 	  
    service = Service("D:/Application/Development/Python/Python37/chromedriver.exe")
    print(service.command_line_args())
    service.start()

    # chrome://version/， 可執行檔的路徑	
    options = webdriver.ChromeOptions()
    options.binary_location = "D:/Application/Browser/Chromium/chrome.exe"
    ...
    # 1 | open | / | 
    driver.get("https://my.ishadowx.biz/")
    print(driver.title) 
